#Objective: Extract salary-related insights for employees numbered between 10500 and 10600 inclusive, focusing on past, current, and future salary values, with differences calculated for meaningful analysis.
