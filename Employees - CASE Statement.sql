#Objective: Extract the employee number, first name, and last name of the first 100 employees, and add a column indicating whether they are still employed or not.
...
#Step 3: CASE Statement for Employment Status
    CASE
...
#Step 4: FROM Clause and JOIN Operation
FROM 
Employees e 
	JOIN 
